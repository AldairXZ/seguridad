...
@Component({
  selector: 'app-group',
  standalone: true,
  imports: [CommonModule, FormsModule, TableModule, ButtonModule, DialogModule, InputTextModule, ToastModule, TooltipModule, MultiSelectModule],
  providers: [MessageService],
  templateUrl: './group.html'
})
export class GroupComponent implements OnInit {
  grupos: any[] = [];
  usuarios: any[] = []; // Empleados disponibles
  ...
  abrirNuevoGrupo() {
    this.grupoActual = { nombre: '', categoria: '', nivel: 'Medio', empleados: [] };
    this.displayDialog = true;
  }

  editarGrupo(grupo: any) {
    this.grupoActual = { ...grupo, empleados: grupo.empleados || [] };
    this.displayDialog = true;
  }
